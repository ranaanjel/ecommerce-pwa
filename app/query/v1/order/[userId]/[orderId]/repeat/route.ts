...
import { orderAll, OrderCollection, UserAddress, userAll } from "@/app/lib/user-placeholder";
...
): Promise<NextResponse<{ result: { success: boolean; data: { address: UserAddress; orderList: any[] } } }>> {

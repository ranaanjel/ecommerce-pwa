...
export type crateItemInterface = { category: string, discountPrice: number, itemname: string, mrp: number, quant: number, unit: unit, skip: boolean, primarySize:string, imageURL:string, buttonURL:string}[];

"use client"
import { CategoryType, Itemlist } from "@/app/(protected)/lib/placeholder-data";
import { localRecentSearch } from "@/app/(protected)/lib/utils";
...
import { FilterModal, filterProps } from "@/app/(protected)/ui/filterModal";
